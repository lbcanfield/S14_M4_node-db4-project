const recipes = [
     { recipe_name: 'Broccoli Presto Pasta' },
...
const steps = [
     ...
     { step_text: 'Put chiken and lemon in oven', step_number: 2, recipe_id: 2 },
     { step_text: 'Put in oven at 500 degrees', step_number: 3, recipe_id: 2 },
     //Salmon en Papillote
     { step_text: 'Fish a salmon in the Bidoasa River', step_number: 1, recipe_id: 3 },
